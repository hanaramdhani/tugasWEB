  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
                ...
                <div class="card brder-dark">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-6">
                        <a href=" beli.php?id_menu=<?php echo $result['id_menu']; ?>" class="btn  btn-sm btn-block btn-tp1" style="background-color: #795548; color: white;">BELI</a>
                      </div>
      ...
      <script type='text/javascript'>
        $('.btn-tp1').on('click', function(event) {
