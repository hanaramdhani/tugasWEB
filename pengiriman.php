                    ...
                    <div class="card card-danger card-outline card-outline-tabs">
                        <div class="card-header p-0 border-bottom-0">
                            <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-dark" id="history-manifest-tab" data-toggle="pill" href="#history-manifest-tab-content" role="tab" aria-controls="history-manifest-tab-content" aria-selected="false"><i class="fas fa-history mr-2"></i>Barang Telah Sampai</a>
                                </li>
                            </ul>
                        </div>
                        <div class="container">
                            ...
                            <div class="tab-content" id="">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($result as $result) : ?>
                                                <tr>
                                                    ...
                                                    <td><button class="btn btn-sm btn-warning" disabled><i class="fa fa-truck"></i></button></td>
                                                    <!-- <td><a href="detail.php?id=<?php echo $result['id'] ?>"
                                                    class="badge badge-primary">Detail</a></td> -->
                                                    <td style='text-align:center'><button class='btn btn-primary btn-sm panggil' data-id="<?= $result['id'] ?>">Detail</button></td>
                                                </tr>
                                                <?php $nomor++; ?>
                                            <?php endforeach; ?>
                                        </tbody>
                                ...
                                <div class="modal fade w-90" id="show" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($result as $result) : ?>
                                                <tr>
                                                    ...
                                                    <td> <a href="detail.php?id=<?php echo $result['id'] ?>" class="badge badge-primary">Detail</a></td>
                                                    <td>
                                                    <td style='text-align:center'><button class='btn btn-primary btn-sm panggil' data-id="<?= $result['id'] ?>">Detail</button></td>
                                                    <td><button class="btn btn-success btn-sm"><i class="fas fa-check-circle"></i></button></td>
