                                ...
                                <tbody>
                                    <?php while ($result = $test->fetch_assoc()) { ?>
                                        <tr class="text-center">
                                            ...
                                            <td style='text-align:center'><button class='btn btn-primary btn-sm panggil' data-id="<?= $result['id_pemesanan'] ?>">Detail</button></td>
                                            <td> <a href="virtual_code.php?id=<?php echo $result['id_pemesanan'] ?>" class="btn btn-warning btn-xs " target="_blank">Virtual
                                                    Account</a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
