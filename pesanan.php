                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($result as $result) : ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        <a href=" detail_pesanan1.php?id=<?php echo $result['id_pemesanan'] ?>" class="btn btn-primary btn-xs "><i class="fa fa-eye"></i></a>
                                                        <a href="clear_pesanan.php?id=<?php echo $result['id_pemesanan'] ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                                        <a href="laporan.php?id=<?php echo $result['id_pemesanan'] ?>" class="btn btn-info btn-xs" target="_blank"><i class="fa fa-print"></i></a>
                                                        <a href="packing.php?id=<?php echo $result['id_pemesanan'] ?>" class="btn btn-warning btn-xs "><i class="fa fa-box"></i></a>
                                                    </td>
                                                </tr>
                                                <?php $nomor++; ?>
                                            <?php endforeach; ?>
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($result as $result) : ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        <a href="laporan.php?id=<?php echo $result['id'] ?>" class="btn btn-info btn-xs " target="_blank"><i class="fa fa-print"></i></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
